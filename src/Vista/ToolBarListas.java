...
public class ToolBarListas extends JToolBar {
	...
	public ToolBarListas(VentanaPrincipal ventanaPrincipal){
		...
		nuevLista.setIcon(new ImageIcon(ToolBarListas.class.getResource("/image/add.png")));
		...
		eliminarLista.setIcon(new ImageIcon(ToolBarListas.class.getResource("/image/delete.png")));
		...
		listaAuto.setIcon(new ImageIcon(ToolBarListas.class.getResource("/image/auto.png")));
		...
		cambiarNombre.setIcon(new ImageIcon(ToolBarListas.class.getResource("/image/modificarCancion.png")));
