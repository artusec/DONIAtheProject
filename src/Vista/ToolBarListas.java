...
public class ToolBarListas extends JToolBar {
	...
	public ToolBarListas(VentanaPrincipal ventanaPrincipal){
		...
		nuevLista.setIcon(new ImageIcon(ToolBarListas.class.getResource("/icons/add.png")));
		...
		eliminarLista.setIcon(new ImageIcon(ToolBarListas.class.getResource("/icons/delete.png")));
		...
		listaAuto.setIcon(new ImageIcon(ToolBarListas.class.getResource("/icons/auto.png")));
		...
		cambiarNombre.setIcon(new ImageIcon(ToolBarListas.class.getResource("/icons/modificarCancion.png")));
